# Credo configuration for Server app
%{
  configs: [
    %{
      name: "default",
      ...
      checks: %{
        enabled: [
          ...
          {Credo.Check.Readability.ModuleDoc, [ignore_names: ["ServerWeb.Telemetry"]]},
        ...
        disabled: [
          # Disabled because we use single-function modules for specific purposes
