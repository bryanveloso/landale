...
class ContextClient:
    ...
    async def get_contexts(self, limit: int = 50, session: Optional[str] = None) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    async def search_contexts(self, query: str, limit: int = 25, session: Optional[str] = None) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    async def get_context_stats(self, hours: int = 24) -> Optional[Dict[str, Any]]:
        """
